...
import static org.firstinspires.ftc.teamcode.other.PosGlobals.blueOpenGateIntakeFinish;
...
@Autonomous(name="bruhBlue15Close")
...
//                new WaitCommand(300),
                ...
                new DriveToPointCommand(driveSubsystem, blueOpenGateIntakeFinish, 5, 5).withTimeout(1500),
