...
public class ShootTimeClose extends SequentialCommandGroup{
    public ShootTimeClose(shooterSubsystem shooterSubsystem, hIntakeSubsystem hIntakeSubsystem, int time, double targetRpm){
        addCommands(
